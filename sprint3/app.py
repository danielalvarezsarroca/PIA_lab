...
df_crop_risk  = load_crop_risk()
df_agri_rules = load_agricultural_rules()
...
st.markdown(
    ...
    <header class="app-header">
      ...
      <div class="app-header-meta">
        ...
        <span class="meta-note">Datos integrados · 6h + demo 10min</span>
      </div>
    </header>
    """,
...
with tab4:
    render_tab_agronomia(df_crop_risk, df_agri_rules)
with tab5:
